...
- 파이어 슛의 데미지는 30이며, 화상 1단계 상태 이상에 걸리며, 등급은 D다.
- 파이어 불렛의 데미지는 45이며, 화상 2단계 상태 이상에 걸리며, 등급은 B다.
- 플레어 쇼크웨이브의 데미지는 80이며, 화상 2단계 상태 이상에 걸리며, 등급은 A다.
- 레드 블래스터의 데미지는 125이며, 화상 3단계 상태 이상에 걸리며, 등급은 R이다.
- 인페르노의 데미지는 170이며, 화상 3단계 상태 이상에 걸리며, 등급은 S다.
