...
- 회복 잔류 효과를 적용받고 있을 경우, 공격에 성공할 때마다 15%만큼의 체력을 회복한다.
- 새로운 마법 아이템 6개를 추가한다.
- 스트렝스 마법 아이템을 추가한다. 스트렝스는 마력 5가 소모되며, 3턴 동안 투지 효과를 플레이어에게 부여하는 효과를 가지고 있다.
- 프로텍트 마법 아이템을 추가한다. 프로텍트는 마력 5가 소모되며, 3턴 동안 수호 효과를 플레이어에게 부여하는 효과를 가지고 있다.
- 리플렉션 마법 아이템을 추가한다. 리플렉션은 마력 5가 소모되며, 3턴 동안 반사 효과를 플레이어에게 부여하는 효과를 가지고 있다.
- 파이트 리커버리 마법 아이템을 추가한다. 파이트 리커버리는 마력 4가 소모되며, 3턴 동안 회복 효과를 플레이어에게 부여하는 효과를 가지고 있다.
- 쇼크 브레이크 마법 아이템을 추가한다. 쇼크 브레이크는 마력 4가 소모되며, 적에게 기절 상태이상을 부여하는 효과를 가지고 있다.
- 블러드 해프닝 마법 아이템을 추가한다. 블러드 해프닝은 마력 4가 소모되며, 적에게 출혈 상태이상을 부여하는 효과를 가지고 있다.
