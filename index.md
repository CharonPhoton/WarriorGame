...
- 총 타입의 무기로 공격하면 무언가 발사하는 소리가 출력되며, 크리티컬이 발생될 경우 무언가가 폭발하면서 발포되는 소리가 출력된다.
...
- 감전 2단계에 걸릴 경우, 3턴 동안 지속이 되며 그동안 몬스터의 원래 치명타 반격 확률이 본래의 25% 만큼 감소한다.
- 감전 3단계에 걸릴 경우, 3턴 동안 지속이 되며 그동안 몬스터의 원래 치명타 반격 확률이 본래의 30% 만큼 감소한다.
