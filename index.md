...
- ~~무속성의 데미지를 주는 마법 아이템을 사용하면 타격 이펙트를 출력하게 한다. (100%)~~
- ~~마법 아이템으로 타격을 주면 마법에 의해 데미지를 받았다는 텍스트를 출력하게 한다.( 텍스트 색깔은 푸른색으로 뜬다. ) (100%)~~
...
- ~~매직 스워드은 챕터 2의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가에 베이는 듯한 효과가 출력된다. (100%)~~
- ~~매직 스워드의 데미지는 40며, 등급은 C다. (100%)~~
- 슬래쉬 블로우는 챕터 3의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가에 충격을 주는 듯한 효과가 출력된다.
- 슬래쉬 블로우는 데미지는 60며, 등급은 A다.
