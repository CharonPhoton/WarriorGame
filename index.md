...
### 17) 32주 게임 시작 화면, 게임 종료 버튼, 게임 엔딩 화면 제작
- 게임 시작 시 화면 중앙에 위 순서대로 게임 이름, 게임 시작 버튼, 게임 조작 방법 버튼, 게임 끝내기 버튼을 추가한다.
- 인게임에서의 포기하기 버튼을 옵션 버튼으로 바꾼다.
- 옵션 버튼을 누르면 게임 종료 버튼과 게임 포기 버튼이 위, 아래로 있다.
- 게임 종료 버튼을 누르면 게임이 종료된다.
- 게임 조작 방법 버튼을 누르면, 게임 조작 방법을 UI로 띄운다.
- 게임 시작 버튼을 누르면, 게임 시작 로딩 화면으로 넘어간다.
- 마왕을 무찌르면 보상을 출력하지 않고 곧바로 게임 엔딩 화면으로 넘어간다.
- 게임 엔딩 화면에서 돌아가기 버튼을 누르면 게임 시작 화면으로 넘어간다.
