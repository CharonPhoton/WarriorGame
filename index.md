...
- 아이스 슛의 데미지는 15이며, 적에게 동결 1단계 상태이상을 부여하며, 등급은 E다.
- 프로스트 슬래셔의 데미지는 30이며, 적에게 동결 1단계 상태이상을 부여하며, 등급은 D다.
- 아이스 캐논의 데미지는 45이며, 적에게 동결 2단계 상태이상을 부여하며, 등급은 C다.
- 프로즌 브레스의 데미지는 80이며, 적에게 동결 2단계 상태이상을 부여하며, 등급은 A다.
- 콜드 웨이브의 데미지는 125이며, 적에게 동결 3단계 상태이상을 부여하며, 등급은 R다.
- 블리자드의 데미지는 170이며, 적에게 동결 3단계 상태이상을 부여하며, 등급은 S다.
**변경 사항**
