...
**추가 사항**
- 소형 접몽 석상을 추가한다.
- 소형 접몽 석상은 재몽석처럼 게임 내에서 사용할 수 있는 저장 아이템으로, 소형 접몽 석상을 사용해서 즉석에서 아이템을 조합할 수 있다.
- 소형 접몽 석상의 가격은 750으로 우선 측정하며, 소형 접몽 석상이 없을 경우, 인게임에서 소형 접몽 석상 버튼을 비활성화시킨다.
- 소형 접몽 석상은 접몽 석상 이용 시 혹은 전투 상황 혹은 대화 상황에서는 켜지지 않게 만든다.

### 33) 42주 Act 5 제작
- Act 5의 몬스터들의 밸런스를 조절한다.
- Act 5에 나오는 대화들을 추가한다.
- Act 5에서 사용되는 대화들을 모두 영문화한다.
- Act 5에서 나오는 효과들을 만든다. ( 몬스터 오라, 배경의 안개 효과 )
