...
### 1) 2~3주 공격 마법 아이템 제작 및 시스템 개선 (A1.008 패치)
...
- 새로운 마법 아이템을 6개를 추가한다.
- ~~매직 미사일은 그린 슬라임을 제외한 챕터 1의 모든 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가에 타격을 받은 듯한 효과가 출력된다. (100%)~~
- ~~매직 미사일의 데미지는 25며, 등급은 E다. (100%)~~
- ~~매직 스워드은 챕터 2의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가를 베는 듯한 효과가 출력된다. (100%)~~
- ~~매직 스워드의 데미지는 40며, 등급은 D다. (100%)~~
- 슬래쉬 블로우는 챕터 3의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가를 두 번 베는 듯한 효과가 출력된다.
- 슬래쉬 블로우는 데미지는 60며, 등급은 B다.
- 쇼크웨이브는 챕터 4의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가에 충격을 주는 듯한 효과가 출력된다.
- 쇼크웨이브는 데미지는 100며, 등급은 A다.
- 에너지 슬래셔는 챕터 5의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가를 수 번 베는 듯한 효과가 출력된다.
- 에너지 슬래셔는 데미지는 150며, 등급은 R다.
- 크레피투스는 챕터 6의 몬스터들에게 15% 확률로 나오며, 무속성의 데미지를 적에게 준다. 이때, 효과는 무언가 터지는 듯한 효과가 출력된다.
- 크레피투스는 데미지는 200며, 등급은 S다.
- 챕터 3의 상자에서 벨트 대신에 가방이 나오도록 변경하며, 확률을 30%에서 40%로 늘린다.
- 모든 고대석의 드랍 확률을 5% 낮춘다. ( 단, 보스는 제외 )
