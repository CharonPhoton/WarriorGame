...
- 몬스터가 크리티컬 데미지를 받을 경우, 뒤로 더 밀려나게 된다.
- 플레이어가 타격을 받을 경우, 화면이 흔들리게 된다. ( 치명타 반격을 받을 경우에는 더 흔들립니다. )
- 플레이어가 타격을 받을 경우, 모두 빨간 점멸이 일어나게 변경된다.
- 몬스터가 치명타 반격을 할 경우, 더 앞으로 다가오는 연출이 추가된다.
- 몬스터가 사망할 때 뒤로 밀려나는 연출이 추가되며, 빨간빛이 돌게 변경된다.
- 전투 이후 보상을 받는 화면에서 진행가기 버튼에 완료 버튼을 추가한다.
- 가방 팝업창의 닫기 버튼의 크기가 조금 커진다.
- 내구도 수리 아이템을 다른 장비 아이템에 드래그 드롭을 할 때, 그 장비 아이템이 해당 내구도 수리 아이템과 호환이 된다면 그 장비 아이템의 내구도가 그 아이템의 효과량만큼 오른다.
- 내구도 수리 아이템을 사용하면, 장착하고 있는 해당 아이템에 호환이 되는 장비 아이템의 내구도가 그 아이템의 효과량만큼 오른다.
- 분노의 고대석과 복수의 고대석은 모두 무기 아이템의 내구도를 회복시켜주며, 각각 2, 3만큼의 내구도를 회복시켜준다.
- 보호의 고대석과 수호의 고대석은 모두 방어구 아이템의 내구도를 회복시켜주며, 각각 2, 3만큼의 내구도를 회복시켜준다.
- 예측의 고대석과 간파의 고대석은 모두 장신구 아이템의 내구도를 회복시켜주며, 각각 2, 3만큼의 내구도를 회복시켜준다.
- 강타의 고대석과 파괴의 고대석은 모두 부적 아이템의 내구도를 회복시켜주며, 각각 2, 3만큼의 내구도를 회복시켜준다.
- 마음의 고대석과 의지의 고대석은 모두 장착하고 있는 아이템들의 내구도를 회복시켜주며, 각각 2, 3만큼의 내구도를 회복시켜준다.
- 분노의 고대석, 보호의 고대석, 예측의 고대석, 강타의 고대석, 마음의 고대석은 모두 3,4 챕터의 몬스터에게 20%로 나온다. 이때 한 몬스터에게 한 고대석만 출현하며, 마음의 고대석은 몬스터와 챕터 상자에서 각각 15%, 10%의 확률로 나온다.
- 복수의 고대석, 수호의 고대석, 간파의 고대석, 파괴의 고대석, 의지의 고대석은 모두 5,6 챕터의 몬스터에게 20%로 나온다. 이때 한 몬스터에게 한 고대석만 출현하며, 의지의 고대석은 몬스터와 챕터 상자에서 각각 15%, 10%의 확률로 나온다.
- 보스 몬스터는 챕터에 따라서 마음의 고대석 또는 의지의 고대석이 15% 확률로 나온다.
